...
- **실시간 모니터링 대시보드 구축**  
  - Streamlit 기반 웹앱으로 예측 결과, 학습/검증 손실, 주요 메트릭을 실시간 시각화  
  - Slack/이메일 알림 연동을 통해 이상치·급변 구간 발생 시 즉시 통보  

- **LLM 기반 자동 분석 보고서 생성**  
  - ChatGPT API 연동으로 주간·월간 예측 요약 및 핵심 지표 리포트 자동 작성  
  - 자연어로 주요 인사이트를 제공해 의사결정 지원  

  ---

> **작성자** : Kim Jeong Cheol (프로젝트 기획·개발·문서화)
